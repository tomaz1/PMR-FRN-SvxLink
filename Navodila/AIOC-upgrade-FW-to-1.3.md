...
Če je/bo potreben spremeniti VID in PID iz CM108 na originalne vrednosti (1209:7388 Generic All-In-One-Cable), ali upgrade, moramo uporabiti trenutni VID in PID za povezavo. [Ideja od tu](../AIOC/www.g1lro.uk-v1.3-RC.1/aioc-revert.py).

Datoteka **[aioc-1.3.0-revert_defaultVIDPID.py](../AIOC/aioc-1.3.0-revert_defaultVIDPID.py)**, da nastavimo nazaj originalne vrednosti.
